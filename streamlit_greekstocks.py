...
st.write(f'Με αρχικό κεφάλαιο {port_value}€, θα κάναμε {rs5["trades"]} συναλλαγές ανά  5 ημέρες, θα είχαμε μια απόδοση {rs5["tot_ret"]} και θα συγκεντρώναμε {rs5["final port_value"]}€')
st.write('   ')
...
st.write(f'Με αρχικό κεφάλαιο {port_value}€, θα κάναμε {rs10["trades"]} συναλλαγές ανά 10 ημέρες, θα είχαμε μια απόδοση {rs10["tot_ret"]} και θα συγκεντρώναμε {rs10["final port_value"]}€')
st.write('   ')
...
st.write(f'Με αρχικό κεφάλαιο {port_value}€, θα κάναμε {rs20["trades"]} συναλλαγές ανά 20 ημέρες, θα είχαμε μια απόδοση {rs20["tot_ret"]} και θα συγκεντρώναμε {rs20["final port_value"]}€')
st.write('   ')
