...
st.write('Με αρχικό κεφάλαιο ', port_value,'€, θα κάναμε ',rs["trades"],' συναλλαγές ανά 5ημέρες  θα είχαμε μια απόδοση ',rs["tot_ret"],' και θα συγκεντρώναμε ', rs["final port_value"],'€')
st.write('   ')
...
st.write('Με αρχικό κεφάλαιο ', port_value,'€, θα κάναμε ',rs["trades"],' συναλλαγές ανά 10ημέρες θα είχαμε μια απόδοση ',rs["tot_ret"],' και θα συγκεντρώναμε ', rs["final port_value"],'€')
st.write('   ')
...
st.write('Με αρχικό κεφάλαιο ', port_value,'€, θα κάναμε ',rs["trades"],' συναλλαγές ανά 20ημέρες θα είχαμε μια απόδοση ',rs["tot_ret"],' και θα συγκεντρώναμε ', rs["final port_value"],'€')
st.write('   ')
